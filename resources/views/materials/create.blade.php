            ...
            <div class="panel p-4 p-md-5">
                <form method="POST" action="{{ route('materials.store') }}">
                    ...
                    <div class="mb-3 d-none" id="cover-picker">
                        ...
                        @foreach ($coverImages as $typeKey => $names)
                                        ...
                                        <div class="col-4 col-sm-3">
                                            <label class="cover-option">
                                                <input
                                                    type="radio"
                                                    name="cover_path"
                                                    value="images/materials/{{ $name }}.png"
                                                >
                                                <img src="{{ asset('images/materials/'.$name.'.png') }}" alt="{{ $name }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="estimated_minutes" name="estimated_minutes" type="number" min="1" class="form-control" value="{{ old('estimated_minutes') }}">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <button type="submit" class="btn btn-accent">追加する</button>
